...
def scatter_plot(hospital_data):
    ...
    fig.add_trace(go.Scatter(
        x=X_test['beds_covid'], y=y_test, mode='markers', name='Actual'))
    fig.add_trace(go.Scatter(
        x=X_test['beds_covid'], y=y_pred, mode='lines', name='Predicted'))
...
def main():
    ...
    # Preprocess the data
    hospital_data, icu_data = preprocess_data(
        hospital_data, icu_data, start_year, end_year)
